...
mv default_server_keystore.jks scripts/default_server_keystore.jks
mv sni_server_keystore.jks scripts/sni_server_keystore.jks

mkdir -p cache-checker/src/main/resources
mv sni_client_truststore.jks cache-checker/src/main/resources/sni_client_truststore.jks
mv default_client_truststore.jks cache-checker/src/main/resources/default_client_truststore.jks
